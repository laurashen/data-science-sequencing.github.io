...
**Submission policy**: Report all plots and your code in [this iPython notebook](/Spr2016/assets/assignment3/ee372_assignment3.ipynb). Print your notebook as a PDF and attach it to the rest of your assignment. Turn in your assignment on the 2nd floor of Packard in the EE372 bin next to the kitchen area.
...
1. Implement the EM algorithm for the error-free case where all transcripts have the same length. Fill in the code in the last cell of the [ipython notebook](/Spr2016/assets/assignment3/ee372_assignment3.ipynb).
