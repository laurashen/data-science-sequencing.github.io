...
Software lab hour: Friday (exact time and location TBA)
...
\end{itemize}
All programming assignments will require require only laptop-level computing. The main language used to code will be Python. UNIX/LINUX/OS X may be needed for some of the software packages. We recommend that windows users use the Corn cluster. 

\subsection*{Projects}
Projects can be theoretic or practical in nature (ideally a mix of the two). A list of possible projects will be put up shortly. Students can also come up with project topics that they are interested in (in consultation with the teaching staff) \\
\end{document}
